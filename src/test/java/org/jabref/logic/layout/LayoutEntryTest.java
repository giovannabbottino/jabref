...
public class LayoutEntryTest {
    ...
    @Test
    public void testParseMethodsCallsNotJavaIdentifier(){
        assertEquals(0, LayoutEntry.parseMethodsCalls("6").size());
    }

    @Test
    public void testParseMethodsCallsOnlyJavaIdentifier(){
        assertEquals(1, LayoutEntry.parseMethodsCalls("_").size());
        assertEquals("_", (LayoutEntry.parseMethodsCalls("_").get(0)).get(0));
    }
    ...
    @Test
    public void testParseMethodsCallsNoText(){
        // [[]] ("")
        assertEquals(0, LayoutEntry.parseMethodsCalls("(\"\")").size());
        // [[]]  (")
        assertEquals(0, LayoutEntry.parseMethodsCalls("(\")").size());
